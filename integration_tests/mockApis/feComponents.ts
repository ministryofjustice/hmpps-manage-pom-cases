...
export const stubFeComponents = (userName: string = 'john smith') => {
  ...
  return stubFor({
    request: {
      method: 'GET',
      urlPattern: '/fe-components/components\\?component=header&component=footer',
    },
    response: {
      status: 200,
